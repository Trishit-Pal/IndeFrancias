		...
		{#each tabs as tab (tab.href)}
			...
			<li class="flex-1">
				<a
					...
					class="flex min-h-11 flex-col items-center justify-center gap-0.5 py-2 text-xs font-medium focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600 {active
						? 'text-blue-600'
						: 'text-slate-500'}"
